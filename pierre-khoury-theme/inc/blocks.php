...
/**
 * Full lockup from the brand guidelines (Pierre Khoury Logo.dc.html,
 * "Layout variants" — Horizontal, for nav/letterhead): the round "pk."
 * icon mark next to the "pierre khoury." wordmark.
 */
function pk_render_logo_block( $attributes ) {
	...
	return sprintf(
		'<a href="%1$s" class="%2$s" aria-label="%3$s"><span class="pk-logo-badge">pk<span class="pk-logo-dot">.</span></span><span class="pk-logo-word">pierre khoury<span class="pk-logo-dot">.</span></span></a>',
		esc_url( home_url( '/' ) ),
		esc_attr( $class ),
